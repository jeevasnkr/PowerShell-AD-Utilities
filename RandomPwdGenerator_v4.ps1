...
- Can generate random N char long passwords. Takes length of the password and number of passwords to be genenrated, as input.

.SYNTAX
.\RandomPwdGenerator_v4.ps1
 #>
...
$Input1 = Is-Numeric $Number  
$Input2 = Is-Numeric $Length   

$Passwords= @() 

if($Input1 -eq 'TRUE' -and $Input2 -eq 'TRUE')
    {
